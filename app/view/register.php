            ...
            <div class="col-lg-6 col-md-8 col-sm-10 register-container">
                ...
                <form method="POST" action="/tokobekas/" onsubmit="return validateForm()" class="p-2">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="emailError" class="invalid-feedback" style="display: none; color: red;">Email must end with @gmail.com.</div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div id="passwordError" class="invalid-feedback" style="display: none; color: red;">Password must be at least 5 characters and contain a number.</div>
                    </div>
